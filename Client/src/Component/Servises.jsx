...
const Servises = () => {
  const data = [
    {
      img: Gimg1,
      heading: 'Naturopathy Treatment-',
      dis: 'Naturopathy teaches that the cure for every disease lies hidden in the earth, water, air, sun, and food around us. From mud packs to sunlight, everything is a remedy. When the body obeys the laws of nature, illness goes away on its own.',
    },
    {
      img: Gimg2,
      heading: 'Naturopathy Techniques-',
      ...
      <div className="p-5">
        ...
        <div className="flex justify-content-center items-center flex-col sm:flex-row flex-grow-1 gap-10 sm:mb-32 mb-20 mt-24">
          {data.map((item, index) => (
            <div
              key={index}
              className="text-[#0b223d] flex justify-center items-center flex-col
                rounded-md p-2
