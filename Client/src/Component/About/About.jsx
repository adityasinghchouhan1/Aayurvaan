          ...
          <div className="mt-16 grid items-center gap-14 lg:grid-cols-2">
            ...
            <div className="text-justify font-serif text-[20px] leading-7 text-gray-700">
              <p className="mb-4">
                ...
                natural harmony of your mind, body, and spirit. It offers a
                truly personalized and transformative healing experience.
              </p>

              <p className="mb-4">
                By blending the ancient wisdom of{' '}
                <span className="font-semibold">Ayurveda</span>, the precision
                of <span className="font-semibold">Homeopathy</span>, the
                balance of <span className="font-semibold">Yoga</span>, and the
                therapeutic strength of{' '}
                <span className="font-semibold">Naturopathy</span>, AAyurvaan
                delivers a complete pathway to wellness.
              </p>

              <p>
                Whether you seek rejuvenation, recovery, or inner balance,
                AAyurvaan nurtures every aspect of your being—helping you
                achieve sustainable health, vitality, and peace naturally.
              </p>
              <p className="mt-5">
